...
import EditSchedule2 from '../components/EditSchedule2';
import Header from '../components/Header';

const EditScheduleView2 = () => {
    ...
    return(
        <View style={styles.container}>
            ...
            <FlatList data={Classes} renderItem={({item}) => <EditSchedule2 item={item} />} />
...
export default EditScheduleView2;