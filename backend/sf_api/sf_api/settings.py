"""
Django settings for sf_api project.
...
ALLOWED_HOSTS = ['10.0.2.2', 'localhost', '127.0.0.1', '192.168.1.71']
...
WSGI_APPLICATION = 'sf_api.wsgi.application'
...
# Set up to use Argon2 by default
